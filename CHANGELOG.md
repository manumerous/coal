...
- Added a Bazel (bzlmod) build for the core `coal` C++ library and its nanobind Python bindings, with CI coverage ([#896](https://github.com/coal-library/coal/pull/896))
